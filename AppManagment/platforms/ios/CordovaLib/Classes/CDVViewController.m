...
//            
//            self.startPage = @"ipad_index.html#/pad_login";
//        }
//        else {
//            
//            self.startPage = @"iphone_index.html#/login";
//        }
//    }
...
- (BOOL)shouldAutorotateToInterfaceOrientation:(UIInterfaceOrientation)interfaceOrientation
{
    ...
    [webView performSelectorOnMainThread:@selector(stringByEvaluatingJavaScriptFromString:) withObject:jsCall waitUntilDone:NO];
